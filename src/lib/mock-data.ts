...
export const partyGames = [
  ...
  },
  {
    ...
    mode: "2-4 baker team",
    href: "/app/moonbeam-bakeoff",
    description: "A co-op kitchen board with station choices, precision prep meters, oven timing, and one shared mooncake score.",
  },
  {
    ...
    mode: "2-6 glow team",
    href: "/app/firefly-grove",
    description: "A route-map puzzle where friends pick both the tool and path to move a firefly swarm through lantern nodes.",
  },
  {
    ...
    mode: "2-4 duet band",
    href: "/app/moonlight-melody",
    description: "A glowing music-staff game with note choices, beat placement, timing accuracy, and a shared phrase combo.",
  },
  {
    id: "lantern-relay",
    title: "Lantern Relay",
...
export const parkGames = [
  ...
  },
  {
    ...
    mode: "co-op kitchen",
    href: "/app/moonbeam-bakeoff",
    description: "A picnic bakery cart for station choices and shared prep-meter timing.",
  },
  {
    ...
    mode: "co-op lanterns",
    href: "/app/firefly-grove",
    description: "A lantern-circle game where friends choose tools and routes together.",
  },
  {
    ...
    mode: "co-op rhythm",
    href: "/app/moonlight-melody",
    description: "A little bandstand for shared beat placement and garden melody combos.",
  },
  {
