...
export const miniGames = [
  ...
  },
  {
    ...
    reward: "Coins + hearts",
    description: "Run recipe stations together: whisk, sprinkle, frost, and time the oven to finish a glowing mooncake.",
    status: "Co-op party",
  ...
  },
  {
    ...
    title: "Firefly Grove",
    reward: "Coins + hearts",
    description: "Route a firefly swarm across a lantern map with nets, breezes, jars, and glowing checkpoints.",
    status: "Co-op party",
  ...
  },
  {
    ...
    reward: "Coins + hearts",
    description: "Play a duet phrase with taps, holds, chimes, and rests on a glowing moonlight music staff.",
    status: "Co-op party",
...
export const partyGames = [
  ...
  },
  {
    ...
    mode: "2-4 baker team",
    href: "/app/moonbeam-bakeoff",
    description: "A co-op kitchen board with ingredient picks, moving prep timing, station choices, and one shared mooncake score.",
  },
  {
    ...
    mode: "2-6 glow team",
    href: "/app/firefly-grove",
    description: "A route-map puzzle where friends pick the tool, path, and swarm formation to guide fireflies through lantern nodes.",
  },
  {
    ...
    mode: "2-4 duet band",
    href: "/app/moonlight-melody",
    description: "A glowing music-staff game with note choices, beat placement, dynamics, timing accuracy, and a shared phrase combo.",
  },
  {
    id: "lantern-relay",
    title: "Lantern Relay",
...
export const parkGames = [
  ...
  },
  {
    ...
    mode: "co-op kitchen",
    href: "/app/moonbeam-bakeoff",
    description: "A picnic bakery cart for ingredient picks, station choices, and shared prep-meter timing.",
  },
  {
    ...
    mode: "co-op lanterns",
    href: "/app/firefly-grove",
    description: "A lantern-circle game where friends choose tools, routes, and firefly formations together.",
  },
  {
    ...
    mode: "co-op rhythm",
    href: "/app/moonlight-melody",
    description: "A little bandstand for beat placement, dynamics, and garden melody combos.",
  },
  {
