...
export const partyGames = [
  ...
  },
  {
    ...
    mode: "2-4 baker team",
    href: "/app/moonbeam-bakeoff",
    description: "A co-op kitchen board with recipe stations, oven heat, frosting, toppings, and one shared mooncake score.",
  },
  {
    ...
    mode: "2-6 glow team",
    href: "/app/firefly-grove",
    description: "A route-map puzzle where friends move a firefly swarm through lantern nodes using the right tool.",
  },
  {
    ...
    mode: "2-4 duet band",
    href: "/app/moonlight-melody",
    description: "A glowing music-staff game with taps, held notes, bell chimes, rests, and a shared phrase combo.",
  },
  {
    id: "lantern-relay",
    title: "Lantern Relay",
