...
const catalogArtById: Record<string, string> = {
  ...
  "chair-lavender-cushion": `${furnitureRoot}/lavender-armchair-v2.png`,
  "bed-cream-canopy": `${furnitureRoot}/canopy-bed.png`,
  "table-honey-tea": `${furnitureRoot}/honey-tea-set.png`,
  ...
  "casper-moonberry-plush": "/game-assets/generated/casper-sprite.png",
  "sofa-blush-cloud": `${furnitureRoot}/blush-loveseat.png`,
  "loveseat-blush-heart": `${furnitureRoot}/blush-loveseat.png`,
  "swing-rose-garden-bench": `${furnitureRoot}/garden-swing-bench.png`,
  "tea-set-honey-stools": `${furnitureRoot}/honey-tea-set.png`,
  "armchair-lavender-heart": `${furnitureRoot}/lavender-armchair-v2.png`,
  "fireplace-honey-stone": `${furnitureRoot}/honey-stone-fireplace.png`,
  "piano-lavender-upright": `${furnitureRoot}/lavender-upright-piano.png`,
  "game-table-garden": `${furnitureRoot}/honey-tea-set.png`,
  "pet-bed-moonberry": `${furnitureRoot}/moonberry-pet-bed.png`,
  "wardrobe-keeper-oak": `${furnitureRoot}/keeper-wardrobe-oak.png`,
  "fountain-lantern-patio": `${worldRoot}/fountain.png`,
  "dance-rug-party-star": `${furnitureRoot}/starlit-party-rug.png`,
  ...
  "casper-boo-bed": `${furnitureRoot}/moonberry-pet-bed.png`,
  ...
  "peppermint-cocoa-table": `${furnitureRoot}/honey-tea-set.png`,
  ...
  "sparkling-toast-table": `${furnitureRoot}/honey-tea-set.png`,
